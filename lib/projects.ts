...
export const PROJECTS: Project[] = [
  ...
  // ── Fashion & Luxury ──────────────────────────────────────
  {
    ...
    imageRatio: 16 / 9,
    cardImage: "/projects/dior/p4.jpg",
    cardImageAlt: "DIOR",
  ...
  },
  {
    ...
    imageRatio: 16 / 9,
    cardImage: "/projects/ralph-lauren/p2.jpg",
  ...
  },
  {
    ...
    imageRatio: 3 / 4,
    cardImage: "/projects/orphic/7.png",
    cardImageAlt: "Orphic",
    category: "fashion-luxury",
    mediaType: "both",
    bgAccent: "#5B3A8C",
...
export const COLLECTIONS: ProjectCollection[] = [
  {
    ...
    cardImage: "/projects/shani/p4.jpg",
    cardImageAlt: "TOTEM",
    category: "concept-fashion",
    bgAccent: "#8B5E3C",
    subProjects: [
  ...
  },
  {
    ...
    cardImage: "/projects/kaleidogami/p1.jpg",
