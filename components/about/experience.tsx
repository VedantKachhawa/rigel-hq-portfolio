...
const ENTRIES: Entry[] = [
  {
    company: "Rigel HQ",
    role: "Founded — Content Production Studio",
    period: "2021 – Present",
    brand: "#0a0a0a",
  },
  {
    company: "DIOR",
    role: "Fashion Campaign — Video & Photography",
    period: "2025",
    brand: "#1a1a2e",
  },
  {
    company: "Ralph Lauren",
    role: "Brand Content & Campaign Production",
    period: "2025",
    brand: "#1a1a1a",
  },
  {
    company: "Jacob & Co",
    role: "Luxury Watch Editorial",
    period: "2024",
    brand: "#0d1b2a",
  },
  {
  ...
  {
    company: "Hershey's",
    role: "Product & Brand Campaign",
    period: "2024",
    brand: "#5B3427",
  },
  {
    company: "Aldar",
    role: "Real Estate Media Production",
    period: "2023",
    brand: "#0C3C78",
  },
  {
    company: "Orphic",
    role: "Brand Launch Campaign",
    period: "2023",
    brand: "#1a0a2e",
  },
];
...
function CompanyLogo({ entry }: { entry: Entry }): ReactNode {
  ...
  return (
    <span
      className="ring-foreground/8 inline-flex h-12 w-12 shrink-0 items-center justify-center ring-1"
      aria-hidden="true"
      style={{
        borderRadius: 14,
        backgroundColor: entry.brand ?? "#0a0a0a",
      }}
    >
      {entry.slug ? (
        <img
