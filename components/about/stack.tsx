...
const CHIPS: Chip[] = [
  { label: "Premiere Pro", slug: "adobepremierepro", bg: "#1f1f1f", fg: "#9999FF" },
  { label: "After Effects", slug: "adobeaftereffects", bg: "#1a0050", fg: "#9999FF" },
  { label: "DaVinci Resolve", slug: "davinciresolve", bg: "#1a1a1a", fg: "#FF8C00" },
  { label: "Lightroom", slug: "adobelightroom", bg: "#001E36", fg: "#31A8FF" },
  { label: "Photoshop", slug: "adobephotoshop", bg: "#001E36", fg: "#31A8FF" },
  { label: "Illustrator", slug: "adobeillustrator", bg: "#2A1800", fg: "#FF9A00" },
  {
    label: "Figma",
    slug: "figma",
    bg: "#1f1f1f",
  ...
  { label: "Frame.io", slug: "frameio", bg: "#0a0a0a", fg: "#ffffff" },
  { label: "Notion", slug: "notion", bg: "#191919", fg: "#ffffff" },
  { label: "Instagram", slug: "instagram", bg: "#C13584", fg: "#ffffff" },
  { label: "TikTok", slug: "tiktok", bg: "#010101", fg: "#ffffff" },
